...
export default function Admin() {
    ...
    useEffect(() => {
        getStoredAdmin().then((data) => {
            setAdmin(data as string);
        }).then(()=> console.log("Pobrano admina"))
        .catch((error) => {
            console.error('Error:', error);
        }).finally(() => {
            console.log("Zakończono pobieranie admina")
        })
    }, [])
            ...
            <div className="flex flex-col justify-center mx-[10vh]">
                ...
                {admin === "true" ?
                    <form onSubmit={formik.handleSubmit} className="flex flex-col space-y-4 bg-primary rounded-lg pb-[4vh]">
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="price">Cena</label>
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="description">Opis</label>
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="quantity">Ilość</label>
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="category">Kategoria</label>
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="brand">Marka</label>
                        ...
                        <label className="bg-secondary rounded m-auto min-w-[30vh] py-[1vh] text-white text-2xl" htmlFor="full_description">Pełny opis</label>
                        ...
                        <button className="bg-secondary py-2 mx-20 px-2 rounded-lg hover:scale-110 text-white" type="submit">Dodaj produkt</button>
                    </form>
                    : null
                }
            </div>
